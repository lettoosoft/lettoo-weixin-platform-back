...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'userprofile_profile', (
            ...
            ('extra_data', self.gf('jsonfield.fields.JSONField')(default={}, null=True, blank=True)),
        ))
        db.send_create_signal(u'userprofile', ['Profile'])

        # Adding model 'AvatarPhoto'
        db.create_table(u'userprofile_avatarphoto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'userprofile', ['AvatarPhoto'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AvatarPhoto'
        db.delete_table(u'userprofile_avatarphoto')
    ...
    models = {
        ...
        u'userprofile.avatarphoto': {
            'Meta': {'object_name': 'AvatarPhoto'},
