...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PublicAccount.enabled'
        db.delete_column(u'weixin_publicaccount', 'enabled')
    ...
    def backwards(self, orm):
        # Adding field 'PublicAccount.enabled'
        db.add_column(u'weixin_publicaccount', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'weixin.publicaccount': {
            ...
            'winxin_id': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
