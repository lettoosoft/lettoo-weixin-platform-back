...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PublicAccountApp.enabled'
        db.add_column(u'weixin_publicaccountapp', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PublicAccountApp.enabled'
        db.delete_column(u'weixin_publicaccountapp', 'enabled')
    ...
    models = {
        ...
        u'weixin.publicaccount': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "u'subscribe'", 'max_length': '10'}),
